...
<div className='col-md'> 
    ...
    <div className='navbar-collapse collapse' id='navbarCollapse'>
      ...
      <ul className="navbar-nav col-3 col-md-6 mb-2 mb-md-0">
        ...
        <li><Link to="/feedback" className="nav-link px-2 link-secondary">Feedback</Link></li>
      ...
      <Button className="nav-link px-1 link-secondary"><img src={myOrderIcon} style={{height:"4rem"}} /></Button>
